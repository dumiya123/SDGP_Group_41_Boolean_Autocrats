  ...
  const handleChangeUsername = async () => {
    try {
      ...
      if (response.ok) {
        ...
        Alert.alert(
          "Error",
          data.message || "Failed to change username. Please try again."
        );
      }
    } catch (error) {
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollViewContent}>
        <View style={styles.content}>
          ...
          <SubtitleComponent
            title={"Enter your new Username and existing password here!"}
          />
          <TextInputField
        ...
        <View style={styles.btn}>
          <SetButton onPress={handleChangeUsername} title="Confirm" />
        </View>
      </ScrollView>
    </SafeAreaView>
  );
